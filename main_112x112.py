...
if __name__ == "__main__":
    ...
    mae = AutoEncoder112(channels=[32, 64, 128, 256], depths=[3, 3, 9, 3]).to(device)
    num_epochs_mae = 10
    ...
    num_classes = 10
    classifier = Classifier112(autoencoder=mae, in_features=768, out_features=num_classes).to(device)
