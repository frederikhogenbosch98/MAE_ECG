...
class Block(nn.Module):
    ...
    def __init__(self, dim, R, in_channels, out_channels, drop_path=0., layer_scale_init_value=1e-6):
        ...
        self.conv1 = tltorch.FactorizedConv.from_conv(nn.Conv2d(in_channels, channels[0], kernel_size=3, stride=1, padding=1), rank=R, decompose_weights=True, factorization=factorization)
