...
#     def __init__(self, dim, R, in_channels, out_channels, factorization='cp', drop_path=0., layer_scale_init_value=1e-6):
#         super().__init__()
#         # self.dwconv = nn.Conv2d(dim, dim, kernel_size=7, padding=3, groups=dim) # depthwise conv
#         self.conv1 = tltorch.FactorizedConv.from_conv(nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=1, padding=1), rank=R, decompose_weights=True, factorization=factorization)
#         self.conv2 = tltorch.FactorizedConv.from_conv(nn.Conv2d(out_channels, out_channels, kernel_size=3, stride=1, padding=1), rank=R, decompose_weights=True, factorization=factorization) 
