...
if __name__ == "__main__":
    ...
    model = (nn.DataParallel(AutoEncoder11(R=15, in_channels=1)).to(device))
    ...
    model.load_state_dict(torch.load('trained_models/RUN_19_5_23_14/MAE_RUN_cp_R15_20_5_5_42.pth'))
