...
if __name__ == "__main__":
    ...
    model = (nn.DataParallel(AutoEncoder11(R=10, in_channels=1)).to(device))
    ...
    model.load_state_dict(torch.load('trained_models/RUN_19_5_23_14/MAE_RUN_cp_R10_20_5_3_30.pth'))
