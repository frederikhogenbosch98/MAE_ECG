...
if __name__ == "__main__":    
    ...
    print(f'N 0s: {Nl.count(0)}')
    print(f'N 1s: {Nl.count(1)}')
    print(f'S 0s: {Sl.count(0)}')
    print(f'S 1s: {Sl.count(1)}')
    print(f'V 0s: {Vl.count(0)}')
    print(f'V 1s: {Vl.count(1)}')
    print(f'F 0s: {Fl.count(0)}')
    print(f'F 1s: {Fl.count(1)}')
    print(f'Q 0s: {Ql.count(0)}')
    print(f'Q 1s: {Ql.count(1)}')# print(f'N: {np.max(Nl)}')
    # print(f'S: {np.max(Sl)}')
    # print(f'V: {np.max(Vl)}')
    # print(f'F: {np.max(Fl)}')
    # print(f'Q: {np.max(Ql)}')