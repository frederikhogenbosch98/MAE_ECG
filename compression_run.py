...
if __name__ == "__main__":
    ...
    R_LIST = [125, 150, 200] # 5, 10, 15, 20, 25, 35, 50, 75, 100,

    CLASSIFY = True
    fact = 'cp'

    now = datetime.now()
    run_dir = f'trained_models/compressed/RUN_{now.day}_{now.month}_{now.hour}_{now.minute}_full_comp_run_rerun_lowerlr2'
